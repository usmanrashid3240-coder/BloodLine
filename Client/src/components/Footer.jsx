        ...
        <div className="grid">
          ...
          <div className="brand">
            ...
            <div className="newsletter">
              <input type="email" placeholder="Update and Type E-mail" />
          ...
          <div className="links">
            <div>
              <h4>Navigation</h4>
              <ul>
                <li onClick={() => navigate('/search')}>🔴 Find a Donor</li>
                <li onClick={() => navigate('/register')}>⚪ Register as Donor</li>
                <li onClick={() => navigate('/blood-banks')}>⚪ Blood Banks List</li>
              </ul>
            </div>
            ...
            <div>
              <h4>Availability</h4>
              <ul>
                <li><span>Mon - Sun</span><span className="green">24 Hours</span></li>
                <li><span>Support</span><span>Active</span></li>
                <li className="location">📍 Lahore, Pakistan</li>
              </ul>
            </div>
          </div>
          ...
          <div className="emergency">
            <div className="card">
              ...
              <a href="tel:080078601">0800-78601</a>

              <div className="social">
                <div onClick={() => window.open('https://facebook.com')}>📘</div>
                <div onClick={() => window.open('https://instagram.com')}>📸</div>
                <div onClick={() => window.open('https://twitter.com')}>🐦</div>
              </div>
            </div>
          </div>
